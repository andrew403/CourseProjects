...
class Platform : public sf::RectangleShape{
    ...
    virtual ~Platform();
    void platUpdate( float x, float y, float boundaryMVMX, float boundaryMVMY);
    void platRender(sf::RenderTarget* target);
    void updatePlatformMovement(float x, float y, float boundaryMVMX, float boundaryMVMY);
