    ...
    public:
        ...
        void onEvent(Event e) {
            if (e.type == "Death"){
                ...
                e.targetObj->boundaryMovementX=0; // Reset the window position
                e.targetObj->boundaryMovementY=0; // Reset the window position
                ...
                e.targetObj->isDead = false;
                //cout<<"Respawned"<<endl;

            }
            else if (e.type == "up"){
                //e.targetObj->jump();
                e.targetObj->mvUp(float(e.spd));

            }
            else if (e.type == "down"){

                e.targetObj->mvDown(float(e.spd));
                ...
                e.targetObj->tmp_boundarymovementX = e.targetObj->boundaryMovementX;
                e.targetObj->tmp_boundarymovementY = e.targetObj->boundaryMovementY;
